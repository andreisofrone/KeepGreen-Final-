...
namespace FieldInspection
{
	static class PlotBars
	{
		public static void PlotBarsChart(BarChartView chart,int day,int year, int month,int week)
		{
			...
			var color = new Android.Graphics.Color[4] { Android.Graphics.Color.DarkGoldenrod, Android.Graphics.Color.Chocolate, Android.Graphics.Color.ForestGreen,Android.Graphics.Color.Red };
